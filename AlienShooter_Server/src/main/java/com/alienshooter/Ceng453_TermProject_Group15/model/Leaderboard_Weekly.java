...
public class Leaderboard_Weekly {
    ...
    This scheduled function is implemented in Scheduled_events.java inside service
    folder.
     */
    ...
    public Leaderboard_Weekly(long user_id,long score_,Date date,String username)
    {
        this.score = score_;
        this.userid = user_id;
        this.date = date;
