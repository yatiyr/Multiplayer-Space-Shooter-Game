 ...
 */
public class StringEncryptDecryptor {
    ...
    public StringEncryptDecryptor(String passphrase2, int determinator) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
